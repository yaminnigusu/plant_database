...
// Fetch plant data where 'shrub' is among the plant types
$sql = "SELECT * FROM plants WHERE FIND_IN_SET('shrub', REPLACE(plant_type, ', ', ',')) > 0";
...
if ($result->num_rows > 0) {
    ...
    echo '<p>No plant records found for shrubs</p>';
}
