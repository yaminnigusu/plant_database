...
<meta charset="UTF-8">
    ...
    <title>Plant Database-water plants</title>
...
$sql = "SELECT * FROM plants WHERE FIND_IN_SET('water_plant', REPLACE(plant_type, ', ', ',')) > 0";
...
if ($result->num_rows > 0) {
    ...
    echo '<p>No plant records found for water plants</p>';
}
